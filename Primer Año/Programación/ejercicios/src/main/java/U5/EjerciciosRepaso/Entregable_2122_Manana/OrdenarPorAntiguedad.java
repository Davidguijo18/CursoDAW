...
public class OrdenarPorAntiguedad implements Comparator<Propiedad> {
    @Override
    public int compare(Propiedad propiedad1, Propiedad propiedad2) {
        if (propiedad1.getAnoConstruccion() > propiedad2.getAnoConstruccion()) {
            return -1;
        } else if (propiedad1.getAnoConstruccion() < propiedad2.getAnoConstruccion()) {
            return 1;
        } else {
